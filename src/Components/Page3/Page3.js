...
import Statusboxs from '../Statusboxs/Statusboxs';
        ...
        <div style={{ border: '1px solid white', marginBottom: '10%', width: '100%', backgroundColor: '#F5F8F8', height: 'auto' }}>
            ...
            <div style={{ margin: '1%', borderRadius: '16px', backgroundColor: '#FFFFFF', padding: '2%', display: 'flex', flexDirection: 'column' }}>
                    ...
                    <div style={{ width: '50%', height: '100%' }}>
                        <div style={{ width: '100%', border: '1px solid #D9D9D9', height: '75%', borderRadius: '16px' }}>
                            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center' }}>
                                ...
                                <p style={{ fontFamily: 'Poppins', fontWeight: '600', fontSize: '28px', lineHeight: '41.44px', color: '#121114', marginBottom: '20%' }}>Sorry! Invalid AWB number</p>
                            </div>
                        </div>
                ...
                <div style={{ display: 'flex', flexDirection: 'row' }}>
                    ...
                    <div style={{ display: 'flex', width: '50%', marginTop: '2%', flexDirection: 'column', backgroundColor: '#F5F8F8', height: '25%' }}>
